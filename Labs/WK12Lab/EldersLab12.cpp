...
int main(){
    ...
    //setup variables to work with files
    ofstream outputFile;
    ifstream inFile;
    ...
    //Decalre variables to read from history file and print to screen
...
cout << "Welcome to Elders' Blackjack Party"<<endl<<endl;
    ...
    do {
        ...
        cout << "4. Walk Away -- Goodbye!" << endl;
        cin >> menuOption;

        while(menuOption < 1 || menuOption >4){
            cout << endl;
            cout << "You have entered an invlalid menu option." << endl;
...
/*WILL FINISH THIS WEEK AND GET CODE UP TO DATE WITH CURRENT CLASS VERSION*/
            ...
            cout<<setw(3)<<right<<gameCounter+1<<setw(16)<<cardValue1<<setw(15)<<cardValue2<<setw(15)<<cardValue3<<setw(15)<<cardValue4<<setw(15)<<cardValue5<<setw(16)<<totalHand<<setw(17)<<dealerHand<<setw(19)<<WL<<setw(16)<<betPlaced<<setw(13)<<totalMoney<<endl;
            outputFile<<setw(3)<<right<<gameCounter+1<<setw(16)<<cardValue1<<setw(15)<<cardValue2<<setw(15)<<cardValue3<<setw(15)<<cardValue4<<setw(15)<<cardValue5<<setw(16)<<totalHand<<setw(17)<<dealerHand<<setw(19)<<WL<<setw(16)<<betPlaced<<setw(13)<<totalMoney<<endl;
        ...
        case 3: //JUST HERE FOR MENU LAB WILL NOT CONTINUE TO BUILD OUT
