...
int cardPointAssign(int Points){
    ...
    cardGenerated = rand()%13;
    if (cardGenerated == 0){
        if (Points <= 10)
                cardPoint[cardGenerated] = 11;
            else
                cardPoint[cardGenerated] = 1;
    }
    
    return cardPoint[cardGenerated];
}

char cardValueAssign(int cardPoint){
    char cardGeneratedValue[] = {'A', '2', '3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K'};
   ...
   /* switch(cardPoint){
        ...
        case 1:
        cardGeneratedValue=cardValues[0];
        break;

        case 2:
        cardGeneratedValue=cardValues[1];
        break;
        
        case 3:
        cardGeneratedValue=cardValues[2];
        break;

        case 4:
        cardGeneratedValue=cardValues[3];
        break;

        case 5:
        cardGeneratedValue=cardValues[4];
        break;

        case 6:
        cardGeneratedValue=cardValues[5];
        break;

        case 7:
        cardGeneratedValue=cardValues[6];
        break;

        case 8:
        cardGeneratedValue=cardValues[7];
        break;

        case 9:
        cardGeneratedValue=cardValues[8];
        break;

        case 10:
        cardGeneratedValue=cardValues[9];
        break;

        case 11:
        cardGeneratedValue=cardValues[10];
        break;

        case 12:
        cardGeneratedValue=cardValues[11];
        break;

        case 13:
        cardGeneratedValue=cardValues[12];
        break;*/
    ...
    //}
    int index;
    index = min(cardPoint, 13)-1;
    return cardGeneratedValue[index];
}
